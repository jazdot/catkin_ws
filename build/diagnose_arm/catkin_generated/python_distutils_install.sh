...
echo_and_run cd "/home/richu/catkin_ws/src/diagnose_arm"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/richu/catkin_ws/src/diagnose_arm/setup.py" \
     \
    build --build-base "/home/richu/catkin_ws/build/diagnose_arm" \
    install \
    --root="${DESTDIR-/}" \
